...
| `weekend_request_approved`  | HOD        | request_id, signature_verified, mismatch_pct, note                  |
| `weekend_request_declined`  | HOD        | request_id, note                                                    |
| `signature_verified`        | system     | hod_decision_id, mismatch_pct                                       |
| `signature_mismatch`        | system     | hod_decision_id, mismatch_pct, threshold                            |
