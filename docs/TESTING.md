...
None of the four workflows runs `design:lint` — no such script exists in `package.json`; it remains aspirational until added. Lighthouse CI was considered and deliberately not pursued — see `docs/CHANGELOG.md`.
