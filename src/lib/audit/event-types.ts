...
export const EVENT_TYPE_MAP: Record<string, AuditEventType> = {
  ...
  KEY_ISSUED: 'ISSUE',
  KEY_RETURNED: 'RETURN',
  KEY_RETURNED_UNVERIFIED: 'RETURN',
  RETURN_CODE_GENERATED: 'RETURN',
  KEY_OVERDUE: 'ANOMALY',
